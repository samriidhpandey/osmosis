     ...
     <div className="container my-5">
      <div className="card shadow-sm rounded-4">
        <div className="card-body px-4 py-5">
          ...
          <ul>
            <li>Unordered List (<code className='p-2'>&lt;ul&gt;</code>)</li>
            <li>Ordered List (<code className='p-2'>&lt;ol&gt;</code>)</li>
            <li>Definition List (<code className='p-2'>&lt;dl&gt;</code>)</li>
          </ul>

          <hr className="my-4" />
          <h4 className="text-warning">1. Unordered List</h4>
          <p>
            This list uses <code className='p-2'>&lt;ul&gt;</code> tag with bullet points. Each item is added using <code className='p-2'>&lt;li&gt;</code>.
          </p>
