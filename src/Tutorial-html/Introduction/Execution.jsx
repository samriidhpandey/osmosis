    ...
    <div className="container my-5">
      ...
      <div className="card shadow mb-4">
        <div className="card-body">
          ...
          <p>Our first website will display the text <code className='p-2'>Hello World</code>.</p>
        </div>
      </div>
      ...
      <div className="card shadow mb-4">
        <div className="card-body">
          ...
          <ol>
            <li>Click on <strong>"Open Folder"</strong> and select a folder (e.g., <code className='p-2'>html-tutorial</code>).</li>
            <li>Click on the <strong>"New File"</strong> icon.</li>
            <li>Type the filename as <code className='p-2'>index.html</code> and hit Enter.</li>
          </ol>
      ...
      <div className="card shadow mb-4">
        <div className="card-body">
          ...
          <p>Copy and paste the following code into your <code className='p-2'>index.html</code> file:</p>
