      ...
      <div className="card shadow rounded-4">
        <div className="card-body px-4 py-5">
          ...
          <p>
            ...
            It is defined using the <code className='p-2'>&lt;ul&gt;</code> tag, and each item is added using <code className='p-2'>&lt;li&gt;</code>.
          </p>
...
{`<ul>
  ...
  <li>Banana</li>
          ...
          <p>
            You can control bullet style using the <code className='p-2'>type</code> attribute or with CSS:
          </p>

          <ul>
            <li><code className='p-2'>disc</code> – default filled circle</li>
            <li><code className='p-2'>circle</code> – hollow circle</li>
            <li><code className='p-2'>square</code> – square bullet</li>
            <li><code className='p-2'>none</code> – no bullet (only using CSS)</li>
          </ul>
