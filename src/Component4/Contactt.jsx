  ...
  return (
    <>
      <div className="container-fluid">
        ...
        <div className="mb-3">
          <label>Phone:</label>
          <input type="tel" className="form-control" name="phone" value={formData.phone} onChange={handleChange} placeholder='Enter your phone no.' required />
        </div>

        <div className="mb-3">
          <label>Subject:</label>
          <input type="text" className="form-control" name="subject" value={formData.subject} onChange={handleChange} placeholder='Enter your subject' required />
        </div>
        ...
        <button type="submit" className="btn btn-light w-25">Send</button>
