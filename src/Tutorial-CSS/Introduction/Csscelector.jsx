    ...
    <>
      ...
      <div className="card shadow-sm border-0 mb-4">
        <div className="card-body">
          ...
          <p>Targets all HTML elements using <code className='p-3'>*</code>.</p>
          <pre className="bg-light p-3 rounded">
            <code className='h-100 p-3 text-white'>
{`* {
  color: purple;
  text-align: center;
}`}
          ...
          <p>
            This applies <code className='h-100 p-3 text-white'>color</code> and <code className='h-100 p-3 text-white'>text-align</code> to every element on the page.
          </p>
...
{`p {
  text-decoration: underline;
          ...
          <p>
            All <code className='h-100 p-3 text-white'>&lt;p&gt;</code> tags will have an underline.
          </p>
      ...
      <div className="card shadow-sm border-0 mb-4">
        <div className="card-body">
          <h4>3. ID Selector</h4>
          <p>Targets an element with a specific ID using <code className='h-100 p-3 text-white'>#</code>.</p>
          <pre className="bg-light p-3 rounded">
            <code className='h-100 p-3 text-white'>
{`#title {
  text-align: center;
  color: red;
          ...
          <p>
            Only the element with <code className='h-100 p-3 text-white'>id="title"</code> gets the style.
          </p>
      ...
      <div className="card shadow-sm border-0 mb-4">
        <div className="card-body">
          ...
          <p>Targets one or more elements using <code className='h-100 p-3 text-white'>.</code> followed by the class name.</p>
          <pre className="bg-light p-3 rounded">
            <code className='h-100 p-3 text-white'>
{`.red {
  color: red;
          ...
          <p>
            All elements with <code className='h-100 p-3 text-white'>class="red"</code> will have red text.
          </p>
      ...
      <div className="card shadow-sm border-0 mb-4">
        <div className="card-body">
          ...
          <p>
            Groups multiple selectors to apply the same styles using <code className='h-100 p-3 text-white'>,</code> (comma).
          </p>
          <pre className="bg-light p-3 rounded">
            <code className='h-100 p-3 text-white'>
{`p, a {
  color: purple;
          ...
          <p>
            Both <code className='h-100 p-3 text-white'>&lt;p&gt;</code> and <code className='h-100 p-3 text-white'>&lt;a&gt;</code> will have purple text.
          </p>
