...
function Homehtml() {
  ...
  const [activeItem, setActiveItem] = useState("intro1"); 
          ...
          <ul className="list-unstyled px-3 py-2 m-0">
            <li className="mb-2">
              <Link
                ...
                className={`text-decoration-none d-block px-3 py-2 rounded sidebar-link ${
                  activeItem === "intro1" ? "active" : ""
                }`}
                onClick={() => handleItemClick("intro1")}
              >
                HTML Introduction
              </Link>
            </li>
            <li className="mb-2">
              <Link
                to="Working"
                className={`text-decoration-none d-block px-3 py-2 rounded sidebar-link ${
                  activeItem === "working" ? "active" : ""
                }`}
                onClick={() => handleItemClick("working")}
              >
                HTML Working
              </Link>
            </li>
