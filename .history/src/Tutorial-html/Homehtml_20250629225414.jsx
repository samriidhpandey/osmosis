...
function Homehtml() {
  ...
  const items = document.querySelectorAll("#flush-collapseOne .list-group-item");
  ...
  return (
    ...
    <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
      <ul style={{ listStyle: "none", paddingLeft: 35 }} className='list-group-item list-group-item-action active'>
                      <li ><Link to="intro1" >HTML Introduction</Link>{""}</li>

                    </ul>
                    <ul style={{ listStyle: "none", paddingLeft: 35 }} className="list-group-item list-group-item-action">
