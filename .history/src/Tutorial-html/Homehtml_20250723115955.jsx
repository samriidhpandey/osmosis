              ...
              <div className="container-fluid">
                <div className="row">
                  <div className="col-12 m-0 p-2 border-bottom">
                    <button className='side-click' onClick={sidelist1}><img src="https://www.freepik.com/icon/sidebar_7560717#fromView=keyword&page=1&position=72&uuid=7d0fa2cf-c27f-4a07-b0b4-b0d50862036e" alt="" /></button> <button class="side-click1 btn btn-white border" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasExample" aria-controls="offcanvasExample" ><img src="https://www.freepik.com/icon/sidebar_7560717#fromView=keyword&page=1&position=72&uuid=7d0fa2cf-c27f-4a07-b0b4-b0d50862036e" alt="" /></button>
                  </div>
