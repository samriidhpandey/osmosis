            ...
            <div className="side-list border-end bg-light" style={{ height: "100vh", overflowY: "auto",overflowX: "hidden"  }} id='sidelist'>
              <div className="row">
                <div className="col-12">
                  <h4 className='text-center mt-2'>HTML Tutorial</h4>
...
<div className="accordion accordion-flush mt-2" id="accordionFlushExample2">
  <div className="accordion-item">
    ...
    >
      <ul className="list-unstyled m-0 px-2 pb-2">
        <li className="mt-2">
          <Link to="Infoform" className="text-decoration-none d-block px-3 py-2 rounded sidebar-link">
            Information to HTML Forms
          </Link>{""}
        </li>
        <li className="mt-2">
          <Link to="Input" className="text-decoration-none d-block px-3 py-2 rounded sidebar-link">
            HTML Input Types
          </Link>{""}
        </li>
        <li className="mt-2">
          <Link to="Textarea" className="text-decoration-none d-block px-3 py-2 rounded sidebar-link">
            Textarea & Select
          </Link>{""}
        </li>
        <li className="mt-2">
          <Link to="Form1" className="text-decoration-none d-block px-3 py-2 rounded sidebar-link">
            More on forms
          </Link>{""}
        </li>
...
<div className="accordion accordion-flush mt-2" id="accordionFlushExample2">
  <div className="accordion-item">
    ...
    >
      <ul className="list-unstyled m-0 px-2 pb-2">
        <li className="mt-2">
          <Link to="Meta1" className="text-decoration-none d-block px-3 py-2 rounded sidebar-link">
            HTML meta tags
          </Link>{""}
        </li>
        <li className="mt-2">
          <Link to="Script" className="text-decoration-none d-block px-3 py-2 rounded sidebar-link">
            Link & Script tags
          </Link>{""}
        </li>
...
<div className="accordion accordion-flush mt-2" id="accordionFlushExample2">
  <div className="accordion-item">
    ...
    >
      <ul className="list-unstyled m-0 px-2 pb-2">
        <li className="mt-2">
          <Link to="Video" className="text-decoration-none d-block px-3 py-2 rounded sidebar-link">
            Video & audio tags
          </Link>{""}
        </li>
        <li className="mt-2">
          <Link to="Svgs" className="text-decoration-none d-block px-3 py-2 rounded sidebar-link">
            SVG in HTML
          </Link>{""}
        </li>
        <li className="mt-2">
          <Link to="Ifram" className="text-decoration-none d-block px-3 py-2 rounded sidebar-link">
            iframes in HTML
          </Link>{""}
        </li>
                                                    ...
                                                    {/* 9 vala section (Miscellaneous Tags) */}
...
<div className="accordion accordion-flush mt-2" id="accordionFlushExample2">
  <div className="accordion-item">
    ...
    >
      <ul className="list-unstyled m-0 px-2 pb-2">
        <li className="mt-2">
          <Link to="Codetag" className="text-decoration-none d-block px-3 py-2 rounded sidebar-link">
            HTML Code Tag
          </Link>{""}
        </li>
        <li className="mt-2">
          <Link to="Sematic" className="text-decoration-none d-block px-3 py-2 rounded sidebar-link">
            HTML Semantic Tags
          </Link>{""}
        </li>
        <li className="mt-2">
              ...
              <div className="container-fluid">
                <div className="row">
                  <div className="col-12 m-0 p-2 border-bottom">
                    <button className='side-click' onClick={sidelist1}><button class="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&amp;_svg]:pointer-events-none [&amp;_svg]:size-4 [&amp;_svg]:shrink-0 hover:bg-accent hover:text-accent-foreground h-7 w-7 -ml-1" data-sidebar="trigger"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-panel-left"><rect width="18" height="18" x="3" y="3" rx="2"></rect><path d="M9 3v18"></path></svg><span class="sr-only">Toggle Sidebar</span></button></button> <button class="side-click1 btn btn-white border" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasExample" aria-controls="offcanvasExample" ><button class="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&amp;_svg]:pointer-events-none [&amp;_svg]:size-4 [&amp;_svg]:shrink-0 hover:bg-accent hover:text-accent-foreground h-7 w-7 -ml-1" data-sidebar="trigger"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-panel-left"><rect width="18" height="18" x="3" y="3" rx="2"></rect><path d="M9 3v18"></path></svg><span class="sr-only">Toggle Sidebar</span></button></button>
                  </div>
