  ...
  return (
    ...
    <div className="container my-5">
      <div className="bg-white border rounded shadow-sm p-4">
        ...
        <h5 className="mt-3">1️⃣ <code className="p-2">action</code></h5>
        <p>
        ...
        <h5>2️⃣ <code className="p-2">method</code></h5>
        <p>
        ...
        <h5>3️⃣ <code className="p-2">name</code></h5>
        <p>
        ...
        <h5>3️⃣ <code className="p-2">autofocus</code></h5>
        <p>
...
{`<form action="/submit.php" method="POST">
  ...
  <input type="text" pattern="[a-zA-Z0-9]+" required>
        ...
        <p>
          Form attributes in HTML enhance both the functionality and user experience of your web forms. HTML5 brought powerful new attributes like <code className="p-2">required</code>, <code className="p-2">autofocus</code>, and <code className="p-2">pattern</code> that help in validating and guiding input before submission. Mastering these will ensure your forms are both usable and secure.
        </p>
