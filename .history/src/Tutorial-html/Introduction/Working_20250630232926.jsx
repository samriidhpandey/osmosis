...
function Working() {
  return (
    <>
      ...
      <motion.div className="card mb-5 shadow rounded-4 p-4"
        ...
        <div className="card-body">
          <h2 className="card-title mb-3">
            <Globe className="me-2 mb-1" size={24} />4. How HTML Works & What is a Browser?
          </h2>

          <h5 className="mt-3"><FileText className="me-2 mb-1" size={18} />1. What is HTML and How Does It Work?</h5>
          ...
          <h5 className="mt-4"><Chrome className="me-2 mb-1" size={18} />2. What is a Web Browser?</h5>
          ...
          <h5 className="mt-4"><Server className="me-2 mb-1" size={18} />3. How Does a Web Browser Work?</h5>
          <ol>
          ...
          <h5 className="mt-4"><Eye className="me-2 mb-1" size={18} />4. Why Do We Need Browsers?</h5>
