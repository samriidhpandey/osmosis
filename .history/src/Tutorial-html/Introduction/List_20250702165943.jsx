...
{`<ol>
  ...
  <li>Have Breakfast</li>
          ...
          <p>
            Used to define terms and their meanings. Includes <code>&lt;dl&gt;</code>, <code>&lt;dt&gt;</code> and <code>&lt;dd&gt;</code>.
          </p>
...
{`<dl>
  ...
  <dd>Styles the page</dd>
          ...
          <ul className="list-group list-group-flush mb-3">
            <li className="list-group-item"><code className=''>&lt;ul&gt;</code>: Defines an unordered list</li>
            <li className="list-group-item"><code>&lt;ol&gt;</code>: Defines an ordered list</li>
            <li className="list-group-item"><code>&lt;li&gt;</code>: Defines a list item</li>
            <li className="list-group-item"><code>&lt;dl&gt;</code>: Defines a definition list</li>
            <li className="list-group-item"><code>&lt;dt&gt;</code>: Defines a term in a definition list</li>
            <li className="list-group-item"><code>&lt;dd&gt;</code>: Defines a description of the term</li>
          </ul>
