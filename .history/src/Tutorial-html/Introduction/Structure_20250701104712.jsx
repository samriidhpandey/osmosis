     ...
     <div className="container my-5">
      ...
      <div className="card shadow mb-4">
        <div className="card-body">
          <p>
            An HTML document is structured using a set of nested tags. Each tag is enclosed within <code>&lt;...&gt;</code> angle brackets and acts as a container for content or other HTML tags.
          </p>
