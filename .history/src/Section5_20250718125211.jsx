...
function Section5({ isDark }) {
      ...
      <div className="container-fluid p-0">
        ...
        <div className="row" style={Section6}>
          <div className="col-12 text-center pt-5 pb-5">
            <div className='m-auto d-flex' style={{ display: "flex", justifyContent: "center", gap: "1rem" }}>
  ...
  />
           ...
           <Link to='Login'></Link> <button className='btn-light mt-5 rounded ps-4 pt-2 pe-4 fs-5 pb-2 border-0'>Start Now</button>
          </div>
        </div>
      </div>
    </>
