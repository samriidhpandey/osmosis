    ...
    <>
      <BrowserRouter>
                ...
                <div className="col-12 d-flex justify-content-end">
                  ...
                  <div className="offcanvas offcanvas-end w-75" tabindex="10000" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
                    ...
                    <div className="offcanvas-body">
                      ...
                      <Link to="/Login" className=' ms-2 '><button className="border-0 pe-3 rounded bg-light shadow-sm p-1">Login</button></Link>{""}
        ...
        <Routes>
          ...
          <Route path='/part1' element={<RSCIT isDark={isDark} />} />
