...
>
  ...
  {/* Larger Screens: Left - Center - Right */}
  <div
    className="d-none d-md-flex justify-content-center align-items-center"
    style={{ gap: '50px' }}
  >
    <span style={{ fontWeight: 'bold' }}>Raghuveer Sain</span>
    <span style={{ fontSize: '1.8rem', fontWeight: 'bold', color: '#FFD700' }}>
      Samridh Pandey
    </span>
    <span style={{ fontWeight: 'bold' }}>Deepankar Pal</span>
  </div>

  {/* Optional copyright */}
  <p style={{ marginTop: '20px', fontSize: '0.9rem', color: '#aaa' }}>
    © {new Date().getFullYear()} Osmosis Computer. All Rights Reserved.
  </p>
</div>
