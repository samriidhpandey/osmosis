...
function Footer({isDark}) {
  ...
  return (
    ...
    onMouseOver={(e) => (e.target.style.textDecoration = "underline")}
    onMouseOut={(e) => (e.target.style.textDecoration = "none")}><div className="social d-flex p-0 mt-3"> <i class="bi bi-linkedin" style={{fontSize:'24px', color:" #f2f2f8ff",}}></i><img className='img-fluid me-2 bg-light rounded' alt="" /> <p> Facebook</p></div> </a>
