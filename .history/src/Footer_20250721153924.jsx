...
function Footer({isDark}) {
  ...
  return (
      ...
      <div className="row border-top" style={footer}>
        <div className="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-11 col-xxl-10 m-auto ">
          <div className="row">
            ...
            <div className="col-6 col-sm-6 col-md-3 col-lg-3 col-xl-3 col-xxl-3 mt-5 ps-4">
              <h5>Legal</h5>
    ...
    onMouseOut={(e) => (e.target.style.textDecoration = "none")}><div className="social d-flex p-0 mt-3"> <i className="bi bi-instagram" style={{fontSize:'24px', color:" #fcf9faff",}}></i><img className='img-fluid me-2 bg-light rounded' alt="" /> <p> Instagram</p></div> </a>
    ...
    onMouseOver={(e) => (e.target.style.textDecoration = "underline")}
    onMouseOut={(e) => (e.target.style.textDecoration = "none")}><div className="social d-flex p-0 mt-3"> <i className="bi bi-youtube" style={{fontSize:'24px', color:" #f9f5f5ff",}}></i><img className='img-fluid me-2 bg-light rounded' alt="" /> <p> Youtube</p></div> </a>
    ...
    onMouseOver={(e) => (e.target.style.textDecoration = "underline")}
    onMouseOut={(e) => (e.target.style.textDecoration = "none")}><div className="social d-flex p-0 mt-3"> <i className="bi bi-facebook" style={{fontSize:'24px', color:" #f2f2f8ff",}}></i><img className='img-fluid me-2 bg-light rounded' alt="" /> <p> Facebook</p></div> </a>
    ...
    onMouseOver={(e) => (e.target.style.textDecoration = "underline")}
    onMouseOut={(e) => (e.target.style.textDecoration = "none")}><div className="social d-flex p-0 mt-3"> <i className="bi bi-linkedin" style={{fontSize:'24px', color:" #f2f2f8ff",}}></i><img className='img-fluid me-2 bg-light rounded' alt="" /> <p>Linkedin</p></div> </a>
