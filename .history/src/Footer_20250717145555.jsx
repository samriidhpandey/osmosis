...
>
  ...
  >
    {/* All Names */}
    <span style={{ fontWeight: 'bold', whiteSpace: 'nowrap' }}>Aayush Meena</span>
    <span style={{ fontWeight: 'bold', whiteSpace: 'nowrap' }}>Bhanu Yadav</span>
    <span style={{ fontWeight: 'bold', whiteSpace: 'nowrap' }}>Samridh Pandey</span>
    <span style={{ fontWeight: 'bold', whiteSpace: 'nowrap' }}>Harsh Vyas</span>
    <span style={{ fontWeight: 'bold', whiteSpace: 'nowrap' }}>Deepak Joshi</span>
  </div>
</div>
