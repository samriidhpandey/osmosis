  ...
  return (
    <>
      ...
      <div className="container-fluid">
        ...
        <div className="position-relative vh-100 w-100 overflow-hidden bg-black text-white">
      <div id="particles-js" className="position-absolute top-0 start-0 w-100 h-100" />

      <div
        className="position-relative z-2 text-center d-flex flex-column justify-content-center align-items-center h-100"
        style={{ zIndex: 2 }}
      >
        <h1 className="display-4 fw-bold animate-glow">Welcome to the Red Realm</h1>
        <p className="lead">Fast & eye-catching animations to engage your users</p>
      </div>
