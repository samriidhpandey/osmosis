    ...
    return(
        ...
        <div className="container" >
            <div className="">
                    ...
                    <img src={stackry}  className="blog-page-img w-75 m-auto d-flex mt-5" />
 ...
 <p className="blog-page-content2 border-0 text-dark p-0 w-100">Stackry acts as a bridge between Indian consumers and US retailers, enabling users to shop from any US store, including giants like Amazon. The process is remarkably straightforward:</p>
             <ol>
                <li > 
                  ...
                  <span> Begin by creating an account on the Stackry website. Provide the necessary information, and you're ready to embark on your international shopping adventure.</span>
                </li>
                <li> 
