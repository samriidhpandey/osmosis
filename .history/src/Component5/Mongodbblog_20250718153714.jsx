        ...
        <>
          <div className="container-fluid  blog-page-main" >
            <div className="">
                    ...
                    <img src={Mongodb2}  className="blog-page-img" />
             ...
             <ol>
                ...
                <li>
                    ...
                    <li>
                        ...
                        <ul>
                    <li> In development, the connection is stored as a global variable (global._mongoClientPromise). This avoids creating multiple connections when the code is reloaded frequently (e.g., during development with Hot Module Replacement). Re-using the global connection prevents memory leaks and unnecessary overhead.</li>
