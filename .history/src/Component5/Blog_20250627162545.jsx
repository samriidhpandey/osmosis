    ...
    return (
        <>
            <div className="container-fluid">
                <div className=" ">
                    <div className="row">
                        <h5 className="blogs-main-name mt-5 mb-4"  >Blogs</h5>

                    </div>
                    <div className="blog-main" >

                        <Card imgsrc={mongodb} text="How to integated mongodb into your next.js apps" content="Learn how to seamlessly integrate MongoDB into your Next.js applications with best practices for efficient connection handling, resource management, and  " button="Read more" more="/Blog/Mongodb" />
                        <Card imgsrc={deploying} text="How to host a Next.js app in Production on an Ubuntu VPS" content="Learn how to deploy a Next.js application in a production environment on an Ubuntu VPS with this comprehensive guide. Follow step-by-step instructions to set up NGINX, ." button="Read more" more="/Blog/Deploying" />
                        <Card imgsrc={staclry} text=" A Comprehensive Guide to Using Stackry for International.." content="In today's interconnected world, the desire for cutting-edge tech gadgets, unique international products, and exclusive US deals has reached an unprecedented level.  " button="Read more" more="/Blog/Stackry" />
                        <Card imgsrc={algorithem} text="How Algorithmic Trading Systems Work" content="  In India, the popularity of online trading has helped transform the financial landscape. This has led to over 20% of all trading is now done via mobile through trading...." button="Read more" more="/Blog/Algorithem" />
                        <Card imgsrc={email} text=" Build an Email Validator with HTML, CSS, and JavaScript" content=" Learn how to create a responsive Email Validator using HTML, CSS, and JavaScript. This step-by-step guide walks you through integrating the Email Validation API to .." button="Read more" more="/Blog/Email" />
