                ...
                <div className="col-11 m-auto tutorial pt-3 pb-3"style={tutorials} >
                    <div className="row">
                      ...
                      <div className="col-12 text-center">
                        ...
                        <Link to='/Htmll'> <button className='w-75 pt-2 pb-2 btn-light border-0 rounded mt-4'>Start Learning!</button></Link>{""}
                      </div>
                    </div>
                </div>
              </div>
                ...
                <div className="col-11 m-auto tutorial pt-3 pb-3"style={tutorials} >
                    <div className="row">
                      ...
                      <div className="col-12 text-center">
                        ...
                        <Link to='/js'><button className='w-75 pt-2 pb-2 btn-light border-0 rounded mt-5'>Start Learning!</button></Link>{""}
                      </div>
                    </div>
                </div>
              </div>
                ...
                <div className="col-11 m-auto tutorial pt-3 pb-3"style={tutorials} >
                    <div className="row">
                      ...
                      <div className="col-12 text-center">
                        ...
                        <p className='mt-4'>Java is a programming language, created in 1995. More than 3 billion devices run...</p>
              ...
              <div className="row">
                <div className="col-11 m-auto tutorial pt-3 pb-3"style={tutorials} >
                    <div className="row">
                      ...
                      <div className="col-12 text-center">
                        <h5 className='fw-bolder mt-2'>C++ Tutorial</h5>
                        <p className='mt-4'>C++ is a cross-platform language that can be used to create high-performance app...</p>
                ...
                <div className="col-11 m-auto tutorial pt-3 pb-3"style={tutorials} >
                    <div className="row">
                      ...
                      <div className="col-12 text-center">
                        ...
                        <p className='mt-4'>The term PHP is an acronym for PHP: Hypertext Preprocessor. It is a server side ...</p>
