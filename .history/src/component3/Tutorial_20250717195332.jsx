        ...
        <div className="col-11 col-sm-10 col-md-10 col-lg-10 col-xl-9 col-xxl-9 m-auto">
          <div className="row">
            ...
            <div className="col-12 col-ms-6 col-md-6 col-lg-4 col-xl-3 col-xxl-3 m-auto mt-3">
             ...
             <div className="col-12 col-ms-6 col-md-6 col-lg-4 col-xl-3 col-xxl-3 m-auto mt-3">
              <div className="row">
                <div className="col-11 m-auto tutorial h-100 pt-3 pb-3"style={tutorials} >
                    <div className="row">
                      <div className="col-6 m-auto">
                      ...
                      <div className="col-12 text-center">
                        ...
                        <Link to='/js'><button className='w-75 pt-2 pb-2 btn-light border-0 rounded'>Start Learning!</button></Link>{""}
                      </div>
                    </div>
                </div>
              </div>
