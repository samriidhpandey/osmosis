...
Explore our free and paid courses and start your learning journey today!
                    ...
                    <p className='mt-5'>
                      <button className='btn-dark border-0 pt-2 ps-4 pe-4 pb-2 rounded-3 m-2'>Explore Courses</button><button className='btn-light border-0 pt-2 ps-4 pe-4 pb-2 rounded-3 m-2'>Read Articles</button></p>
