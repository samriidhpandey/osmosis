    ...
    <div className="container py-4">
      ...
      <div className="card shadow-sm border-0 mb-4">
        <div className="card-body">
          ...
          <p>Use the <code>style</code> attribute inside the HTML tag:</p>
...
<h2>I'm CodeWithHarry</h2>`}
          ...
          <p>
            Here, only the <code>h1</code> element gets the purple color style.
          </p>
      ...
      <div className="card shadow-sm border-0 mb-4">
        <div className="card-body">
          ...
          <p>
            Internal CSS is written inside a <code>&lt;style&gt;</code> block
            inside the <code>&lt;head&gt;</code> of the HTML file. It can target multiple elements.
          </p>
          <pre className="bg-light p-3 rounded">
            <code>
{`<head>
...
<body>
  ...
  <p>I'm a Developer and founder of CodeWithHarry.com</p>
          ...
          <p>
            All <code>&lt;p&gt;</code> tags will have red text.
          </p>
          <p className="text-muted">📷 [CWH tutorial image]</p>
        </div>
      </div>
      ...
      <div className="card shadow-sm border-0 mb-4">
        <div className="card-body">
          ...
          <p>
            External CSS is written in a separate file (e.g., <code>style.css</code>)
            and linked to the HTML using the <code>&lt;link&gt;</code> tag.
          </p>
...
{`p {
  color: red;
          ...
          <ul>
            <li><code>&lt;link&gt;</code>: connects the HTML to external resources.</li>
            <li><code>rel="stylesheet"</code>: tells browser this is a CSS file.</li>
            <li><code>href="style.css"</code>: path to the external file.</li>
          </ul>
      ...
      <div className="card shadow-sm border-0">
        <div className="card-body">
          ...
          <p className="fw-semibold">
            <code className='p-3 text'>Inline CSS &gt; Internal CSS &gt; External CSS</code>
          </p>
