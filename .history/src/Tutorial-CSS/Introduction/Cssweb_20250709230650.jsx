...
function Cssweb() {
  return (
    <>
    <div className="container shadow-lg pb-5 border rounded  py-4">
        ...
        <div className="col-12">
          <div className="card shadow-sm border-0">
            <div className="card-body">
              ...
              <p>
                Assuming you have some knowledge of HTML, open VS Code and create a new file named <code className='p-2'>index.html</code>.
              </p>
              <p>After creating the HTML file, type <code className='p-2'>!</code> and press enter. This will generate the default HTML boilerplate.</p>
              <p>The generated code should look something like this after changing the title and adding some content:</p>
              <pre className="bg-light p-3 rounded">
                <code className='h-100 text-white p-3'>
{`<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
