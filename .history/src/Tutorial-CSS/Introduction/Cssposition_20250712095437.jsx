...
{`img {
  position: static;
        ...
        <div className="bg-light p-3 mt-3">
          ...
          <img src="https://via.placeholder.com/100" alt="Static Example" />
        </div>
      </div>
...
{`img {
  ...
  top: 50px;
        ...
        <div className="bg-light p-3 mt-3 position-relative" style={{ height: '150px' }}>
          <img src="https://via.placeholder.com/100" alt="Relative Example" style={{ position: 'relative', left: '100px', top: '50px' }} />
        </div>
      </div>
...
.logo {
  ...
  top: 10px;
        ...
        <div className="position-relative bg-light p-4 mt-3" style={{ height: '150px' }}>
          ...
          <img src="https://via.placeholder.com/50" className="position-absolute" alt="Absolute Example" style={{ right: '10px', top: '10px' }} />
        </div>
      </div>
...
{`h1 {
  ...
  right: 20px;
        ...
        <div className="bg-light p-3 mt-3" style={{ height: '120px' }}>
