...
function Notes({isDark}) {
  ...
  function Heading({ text,}) {
    return (
      <h3 className="blog-page-hading text-white mb-5">{text}</h3>
    );
  }
  ...
  return (
    <>
      <div className="container-fluid pt-2 pb-5" style={notes}>
        <div className="notes-dowload">  <Heading text={"Download Notes"} /> </div>
...
/> */}
          ...
          />
          <div className="row w-100 notes-dowload">  <Heading text={"Download Cheatsheets"} style={notetext} /> </div>
