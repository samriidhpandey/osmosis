            ...
            <div className="col-4 col-sm-5 col-md-7 col-lg-5 col-xl-5 col-xxl-5">
              <div className="row mt-4 mb-3">
                <div className="col-12 d-flex justify-content-end">
                  ...
                  <div className="modal fade mt-5" id="exampleModal" tabindex="" aria-labelledby="exampleModalLabel" aria-hidden="true">
                  ...
                  <div className="bars ms-3 mt-1"><i classn="fa-solid fa-bars fs-3 me-4 p-0 m-auto" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight"></i></div>
