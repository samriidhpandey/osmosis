        ...
        <div className="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-11 col-xxl-10 m-auto ">
          <div className="row">
            ...
            <div className="col-6 col-sm-6 col-md-3 col-lg-3 col-xl-3 col-xxl-3 mt-5">
              <h5>Learn</h5>
              <Link to="/Login" className='text-white'></Link><p>Course</p>
              <Link to="/Login" className='text-white'></Link><p>Tutorials</p>
              <Link to="/Login" className='text-white'></Link><p>Notes</p>
