    ...
    <>
      ...
      <BrowserRouter>
        ...
        <div className="container-fluid">
          ...
          <Courses title="hello | Learn Smart" description="Join RS-CIT, Tally, and more at Osmosis Computer." isDark={isDark} />
        </div>
        ...
        <Routes>
          ...
          <Route path='/Courses' element={<Courses title="hello | Learn Smart" description="Join RS-CIT, Tally, and more at Osmosis Computer." isDark={isDark} />} />
