...
function Courses({isDark,title, description }) {
  ...
  return (
    ...
    <>
   <Helmet>
        <title>About Us - Samridh's Vite App</title>
        <meta name="description" content="This is the about page using Helmet in Vite + React." />
        <meta name="keywords" content="React, Vite, Helmet, SEO" />
        <meta charSet="utf-8" />
      </Helmet>
    {/* <BrowserRouter> */}
