      ...
      <div className="container-fluid">
        <div className="row part1-page border-top" style={part1}>
          ...
          <div className="col-12 col-sm-12 col-md-11 col-lg-10 col-xl-11 col-xxl-12 ps-4 part1-tex m-auto">
            ...
            <h1>[English] Complete 2025 Python Bootcamp: Learn Python from Scratch</h1>
            <p className='mt-4 fs-5 pe-5 '>Ready to break into the world of Data Science? This all-in-one Job-Ready  Data <br /> Science Course is designed for beginners and intermediate learners who want to <br /> master data science skills and become industry-ready with hands-on experience.  <br /> Science Course is designed for beginners and intermediate learners who<br/> Demand  </p>
