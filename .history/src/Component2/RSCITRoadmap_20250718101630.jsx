...
const RSCITRoadmap = ({ isDark }) => {
  ...
  const bg = kMode ? "#121212" : "linear-gradient(to bottom, #f8d7da, white)";
  const cardBg = kMode ? "#1e1e1e" : "white";
  const textColor = kMode ? "#f1f1f1" : "#8B0000";
  const paraColor = kMode ? "#aaa" : "#555";
  const borderColor = kMode ? "#333" : "#f5c6cb";
  const shadow = kMode ? "0 2px 8px rgba(255,255,255,0.05)" : "0 2px 8px rgba(0,0,0,0.1)";
