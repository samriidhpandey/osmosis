...
function Courses({isDark}) {
  ...
  return (
    ...
    <div className="container-fluid">
      ...
      <strong className='mt-0'>Duration:</strong> 3 Months
      <strong className='mt-0'>Days:</strong> Monday to Saturday
      <strong>Daily Class:</strong> 1 Hour
      <strong>Mode:</strong> Offline/Online Available
