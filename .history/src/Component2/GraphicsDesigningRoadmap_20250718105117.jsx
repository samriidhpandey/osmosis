...
const GraphicsDesigningRoadmap = ({ isDark }) => {
  ...
  const bg = isDark ? "#0b0d1c" : "linear-gradient(to bottom, #f1f8ff, white)";
  const cardBg = isDark ? "#1c1f2e" : "white";
  const textColor = isDark ? "#f1f1f1" : "#003366";
  const paraColor = isDark ? "#bbb" : "#444";
  const borderColor = isDark ? "#333" : "#d0e6ff";
