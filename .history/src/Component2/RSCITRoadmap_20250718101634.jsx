...
const RSCITRoadmap = ({ isDark }) => {
  ...
  const bg = isDarkkMode ? "#121212" : "linear-gradient(to bottom, #f8d7da, white)";
  const cardBg = isDarkkMode ? "#1e1e1e" : "white";
  const textColor = isDarkkMode ? "#f1f1f1" : "#8B0000";
  const paraColor = isDarkkMode ? "#aaa" : "#555";
  const borderColor = isDarkkMode ? "#333" : "#f5c6cb";
  const shadow = isDarkkMode ? "0 2px 8px rgba(255,255,255,0.05)" : "0 2px 8px rgba(0,0,0,0.1)";
