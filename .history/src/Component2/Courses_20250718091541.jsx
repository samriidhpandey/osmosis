...
function Courses({isDark}) {
  ...
  return (
    ...
    <div className="container-fluid">
      ...
      <p className=''><strong>Duration:</strong> 3 Months</p>
      <p className=''><strong>Days:</strong> Monday to Saturday</p>
      <p className=''><strong>Daily Class:</strong> 1 Hour</p>
      <p className=''><strong>Mode:</strong> Offline/Online Available</p>
