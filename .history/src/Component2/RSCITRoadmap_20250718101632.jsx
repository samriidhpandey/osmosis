...
const RSCITRoadmap = ({ isDark }) => {
  ...
  const bg = iskMode ? "#121212" : "linear-gradient(to bottom, #f8d7da, white)";
  const cardBg = iskMode ? "#1e1e1e" : "white";
  const textColor = iskMode ? "#f1f1f1" : "#8B0000";
  const paraColor = iskMode ? "#aaa" : "#555";
  const borderColor = iskMode ? "#333" : "#f5c6cb";
  const shadow = iskMode ? "0 2px 8px rgba(255,255,255,0.05)" : "0 2px 8px rgba(0,0,0,0.1)";
