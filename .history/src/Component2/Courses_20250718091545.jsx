...
function Courses({isDark}) {
  ...
  return (
    ...
    <div className="container-fluid">
      ...
      <p className='mt-0'><strong>Duration:</strong> 3 Months</p>
      <p className='mt-0'><strong>Days:</strong> Monday to Saturday</p>
      <p className='mt-0'><strong>Daily Class:</strong> 1 Hour</p>
      <p className='mt-0'><strong>Mode:</strong> Offline/Online Available</p>
