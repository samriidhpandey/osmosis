...
function Footer({isDark}) {
  ...
  return (
    ...
    onMouseOut={(e) => (e.target.style.textDecoration = "none")}><div className="social d-flex p-0 mt-3"> <i class="bi bi-instagram" style={{fontSize:'24px', color:" #fcf9faff",}}></i><img className='img-fluid me-2 bg-light rounded' alt="" /> <p> Instagram</p></div> </a>
