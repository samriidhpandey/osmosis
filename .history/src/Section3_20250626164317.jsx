        ...
        <div className="col-11 col-sm-11 col-md-10 col-lg-10 col-xl-9 col-xxl-10 mt-5 m-auto">
            <div className="row">
              <div className="col-6 col-sm-6 col-md-4 col-lg-3 col-xl-2 col-xxl-2">
                <div className="row p-1 ">
                  <div className="col-11 icon m-auto">
                    <img src={icon1} className='img-fluid m-2' alt="" />
                  </div>
                </div>
              </div>
              ...
              <div className="col-6 col-sm-6 col-md-4 col-lg-3 col-xl-2 col-xxl-2">
                <div className="row p-1 ">
                  <div className="col-11 icon m-auto">
                    <img src={icon2} className='img-fluid m-2 ' alt="" />
                  </div>
                </div>
              </div>
              ...
              <div className="col-6 col-sm-6 col-md-4 col-lg-3 col-xl-2 col-xxl-2">
                <div className="row p-1 ">
                  <div className="col-11 icon m-auto">
                    <img src={icon3} className='img-fluid m-2' alt="" />
                  </div>
                </div>
              </div>
              ...
              <div className="col-6 col-sm-6 col-md-4 col-lg-3 col-xl-2 col-xxl-2">
                <div className="row p-1 ">
                  <div className="col-11 icon m-auto">
                    <img src={icon4} className='img-fluid m-2' alt="" />
                  </div>
                </div>
              </div>
              ...
              <div className="col-6 col-sm-6 col-md-4 col-lg-3 col-xl-2 col-xxl-2">
                <div className="row p-1 ">
                  <div className="col-11 icon m-auto">
                    <img src={icon5} className='img-fluid m-2' alt="" />
                  </div>
                </div>
              </div>
              ...
              <div className="col-6 col-sm-6 col-md-4 col-lg-3 col-xl-2 col-xxl-2">
                <div className="row p-1 ">
                  <div className="col-11 icon m-auto">
                    <img src={icon6} className='img-fluid m-2' alt="" />
                  </div>
                </div>
              </div>
               ...
               <div className="col-6 col-sm-6 col-md-4 col-lg-3 col-xl-2 col-xxl-2">
                <div className="row p-1 ">
                  <div className="col-11 icon m-auto">
                    <img src={icon7} className='img-fluid m-2' alt="" />
                  </div>
                </div>
              </div>
              ...
              <div className="col-6 col-sm-6 col-md-4 col-lg-3 col-xl-2 col-xxl-2">
                <div className="row p-1 ">
                  <div className="col-11 icon m-auto">
                    <img src={icon8} className='img-fluid m-2 ' alt="" />
                  </div>
                </div>
              </div>
              ...
              <div className="col-6 col-sm-6 col-md-4 col-lg-3 col-xl-2 col-xxl-2">
                <div className="row p-1 ">
                  <div className="col-11 icon m-auto">
                    <img src={icon9} className='img-fluid m-2' alt="" />
                  </div>
                </div>
              </div>
              ...
              <div className="col-6 col-sm-6 col-md-4 col-lg-3 col-xl-2 col-xxl-2">
                <div className="row p-1 ">
                  <div className="col-11 icon m-auto">
                    <img src={icon10} className='img-fluid m-2' alt="" />
                  </div>
                </div>
              </div>
              ...
              <div className="col-6 col-sm-6 col-md-4 col-lg-3 col-xl-2 col-xxl-2">
                <div className="row p-1 ">
                  <div className="col-11 icon m-auto">
                    <img src={icon11} className='img-fluid m-2' alt="" />
                  </div>
                </div>
              </div>
              ...
              <div className="col-6 col-sm-6 col-md-4 col-lg-3 col-xl-2 col-xxl-2">
                <div className="row p-1 ">
                  <div className="col-11 icon m-auto">
                    <img src={icon12} className='img-fluid m-2' alt="" />
                  </div>
                </div>
              </div>
            </div>
