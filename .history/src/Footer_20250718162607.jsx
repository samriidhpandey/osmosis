      ...
      <div className="row border-top" style={footer}>
        <div className="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-11 col-xxl-10 m-auto ">
          <div className="row">
            ...
            <div className="col-6 col-sm-6 col-md-3 col-lg-3 col-xl-3 col-xxl-3 mt-5">
              <h5>Social</h5>
             a <div className="social d-flex p-0 mt-3"> <i class="bi bi-instagram" style={{fontSize:'24px', color:" #E1306C",}}></i><img className='img-fluid me-2 bg-light rounded' alt="" /> <p> Instagram</p></div> 
