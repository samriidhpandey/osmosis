...
function Footer({isDark}) {
  ...
  <footer style={{ padding: "1.5rem", textAlign: "center", backgroundColor: isDark ? "#000" : "#eee", color: isDark ? "#aaa" : "#333" }}>
  Made with ❤️ by Samridh Pandey, Name2, Name3, Name4, and Name5 — Students of Osmosis Computer, Jodhpur.
</footer>
