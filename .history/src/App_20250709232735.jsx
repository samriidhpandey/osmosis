...
import Syntax from './Tutorial-CSS/Introduction/Syntax';
            ...
            <div className="col-8 col-sm-7 col-md-5 col-lg-7 col-xl-7 col-xxl-7">
              <div className="row">
                <div className="col-6 col-sm-5 col-md-6 col-lg-3 col-xl-3 col-xxl-3  logo">
                  <h3 className=''>
                    <img src={logo} className=' ms-1' style={{width:"140px",}}  alt="" />
                  </h3>
                </div>
            ...
            <div className="col-4 col-sm-5 col-md-7 col-lg-5 col-xl-5 col-xxl-5">
              <div className="row mt-4 mb-3">
                <div className="col-12 d-flex justify-content-end">
                  ...
                  <div class="modal fade click-too" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                  ...
                  <dev className=" border-0 rounded ms-2 me-4 res" >
                    <label class="switch" >
                  ...
                  <div className="bars ms-3 mt-1"><i class="fa-solid fa-bars fs-3 me-4 p-0 m-auto" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight"></i></div>
                    

<div class="offcanvas offcanvas-end" tabindex="10000" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
  ...
  <div class="offcanvas-body">
    <p className='mt-4'><Link to='/' className='menu1'>Home</Link></p>
                  ...
                  <p className='mt-4'><Link to='/' className='menu1'>Blog</Link></p>
                  <p className='mt-4'><Link to='/' className='menu1'>Notes</Link></p>
                  <p className='mt-4'><Link to='/Contact' className='menu1'>Contact</Link>{""}</p>
                  <Link to="/Login" className=' ms-2 '><button className="border-0 ps-3 pe-3 rounded bg-light shadow-sm p-1">Login</button></Link>{""}
                  <Link to="/Signup" className=' ms-2'><button className="border-0 ps-3 pe-3 rounded bg-light shadow-sm p-1">Signup</button></Link>{""}
                  {/* <button className=" border-0 ps-3 pe-3 rounded bg-white ms-2 res">Signup</button> */}
                  <dev className=" border-0 rounded ms-2 me-4 shadow-sm border" >
                    <label class="switch" >
                      <input type="checkbox" id="toggleSwitch" onClick={toggleDark} />
                      <span class="slider"></span>
                    </label>
        ...
        <Routes>
          ...
          <Route path='/part1' element={<Part1 isDark={isDark} />} />
          <Route path='/part2' element={<Part2 isDark={isDark} />} />
        ...
        <Route path='notescss' element={<Homecss/>}>
            <Route index element={<Pagecss to="intro" replace />} />
              ...
              <Route path="Syntax" element={<Cssweb/>} /> 
        </Route>
