...
const AdminDashboard = () => {
  ...
  return (
    <div className="container mt-5"> // Example: AdminHeader.jsx ya Dashboard.jsx me
<button
  onClick={() => {
    localStorage.removeItem("admin-token"); // ya jo bhi key use ho rahi ho
    window.location.href = "/admin-login"; // ya navigate("/admin-login") agar react-router use ho raha ho
  }}
